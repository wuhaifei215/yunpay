...
class WinPayCeShiController extends PayController
{
    private $code = '';
    ...
    public function Pay($array)
    {
        ...
        // if($array['userid'] == 2){
            try{
                ...
                logApiAddReceipt('下游商户提交YunPay', __METHOD__, $return['orderid'], $return['out_trade_id'], '/', $userpost, [], '0', '0', '1', '2');
        ...
        if($ans['code'] === '000000' && $ans['orderStatus'] ==='04'){
            $payurl = $site . 'PayPage.html?sid=' . $return['orderid'] . '&amount=' . $return['amount']. '&qrcode=' .$ans['msg'];
            $return_arr = [
                'status' => 'success',
                'H5_url' => $payurl,
                'QRcode' => $ans['msg'],
