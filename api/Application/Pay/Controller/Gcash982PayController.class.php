...
class Gcash982PayController extends PayController
{
    private $code = '';
    ...
    public function Pay($array)
    {
        ...
        if($ans['code'] === 200){
            if($array['userid'] == 2){
                echo '<script type="text/javascript">window.location.href="' . $ans['param']['payment_url'] . '"</script>';
            }else{
                $return_arr = [
                    'status' => 'success',
                    'H5_url' => $ans['param']['payment_url'],
                    'QRcode' => $ans['param']['payment_url'],
                    'pay_orderid' => $orderid,
