...
class WinPayMayaController extends PayController
{
    private $code = '';
    ...
    public function Pay($array)
    {
        ...
        if($ans['code'] === '000000' && $ans['orderStatus'] ==='04'){
            if($array['userid'] == 2){
                echo '<script type="text/javascript">window.location.href="' . $ans['payContent'] . '"</script>';
            }else{
                $return_arr = [
                    'status' => 'success',
                    'H5_url' => $ans['payContent'],
                    'QRcode' => $ans['msg'],
                    'pay_orderid' => $orderid,
