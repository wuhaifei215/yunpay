...
class TigerPayIndWakeDFController extends PaymentController
{
    private $code = '';
    ...
    {
        if(!in_array($data['type'],['Banktransfer', 'UPI', 'IMPS'])){
        ...
        $post_data = array(
            ...
            "bankType" => $data['type'],        // IMPS ，NEFT，RTGS，UPI
            "bankName" => $data['bankname'],
            "bankClearingNumber" => $data['bankzhiname'],
