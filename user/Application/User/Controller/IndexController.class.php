...
//         $this->assign('chartData2',$datatwo);
        ...
        // $field = ['sum(`pay_amount`) amount','count(`id`) success_count'];
        ...
        // ];
        // $OrderModel = D('Order');
        // $data_all = $OrderModel->getOrderByDateRange($field, $where_all);
        // // $data_all = M('Order')->field($field)->where($where_all)->find();
        // //总成交订单数
        // $stat['totalordercount'] = $data_all['success_count'];
        // //总成交订单总额
        // $stat['totalordersum'] = $data_all['amount'];
        
        
        // $monthBegin = date('Y-m-01').' 00:00:00';
        // $where_month = [
        //     'pay_memberid'=>$uid,
        //     'pay_applydate'=>['egt',strtotime($monthBegin)], 
        //     'pay_status'=>['between', [1, 2]]
        // ];
        // $data_month = $OrderModel->getOrderByDateRange($field, $where_month);
        // // $data_month = M('Order')->field($field)->where($where_month)->find();
        // //本月成交订单数
        // $stat['monthordercount'] = $data_month['success_count'];
        // //本月成交订单总额
        // $stat['monthordersum'] = $data_month['amount'];
        ...
        //     'pay_status'=>['between', [1, 2]]
        // ];
        // $data_month = $OrderModel->getOrderByDateRange($field, $where_today);
        // // $data_today = M('Order')->field($field)->where($where_today)->find();
        // //本月成交订单数
        // $stat['todayordercount'] = $data_today['success_count'];
        // //本月成交订单总额
        // $stat['todayordersum'] = $data_today['amount'];
