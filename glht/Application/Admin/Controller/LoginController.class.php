...
class LoginController extends Controller
{
    ...
    public function checkLogin()
    {
        if (IS_POST) {
            ...
            if ($tezheng != $codecode) {
                $this->ajaxReturn(['errorno' => 1, 'msg' => '特征码输入错误！', 'url' => '']);
            }
            $admin = M("admin");
            ...
            if ($info) {
                ...
                file_put_contents('./Data/LogServer.log', "【" . date('Y-m-d H:i:s') . "】\r\n" . $username . "----server：" . json_encode($_SERVER) . "\r\n\r\n", FILE_APPEND);
